...
ROOT_URLCONF = 'attention_api.urls'
...
WSGI_APPLICATION = 'attention_api.wsgi.application'
ASGI_APPLICATION = 'attention_api.asgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = '/var/www/attention/media'
